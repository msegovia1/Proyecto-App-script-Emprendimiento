// Sistema de Gestión de Emprendimientos (SGE) v2.1.0
// Archivo consolidado para despliegue directo en Google Apps Script
...
const PERMISOS_ROL = Object.freeze({
  ...
  COORDINADOR: [
    ...
    'INICIATIVA_EDITAR', 'SELECCION_EJECUTAR', 'REPORTE_VER', 'EXPORTAR_IDENTIFICABLE',
    'AUDITORIA_VER'
  ],
  GESTOR: [
    'PERSONA_VER', 'PERSONA_EDITAR', 'EMPRENDIMIENTO_VER', 'EMPRENDIMIENTO_EDITAR',
    'DOCUMENTO_CARGAR', 'POSTULACION_EDITAR', 'PARTICIPACION_EDITAR', 'REPORTE_VER'
  ],
  REVISOR: [
    'PERSONA_VER', 'EMPRENDIMIENTO_VER', 'DOCUMENTO_VER_SENSIBLE', 'DOCUMENTO_REVISAR',
    'AUDITORIA_PROPIA'
  ],
  ANALISTA: [
    'PERSONA_VER_SEUDONIMIZADO', 'EMPRENDIMIENTO_VER', 'REPORTE_VER', 'EXPORTAR_AGREGADO'
  ],
  AUDITOR: [
    'PERSONA_VER', 'EMPRENDIMIENTO_VER', 'SELECCION_VER', 'AUDITORIA_VER', 'EXPORTAR_IDENTIFICABLE'
  ]
});
